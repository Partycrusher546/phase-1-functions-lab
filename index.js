...
console.log(
  `The pickup location is ${blocksToHq} blocks away from  Scubar's headquarters.`
);
//question 2
function distanceFromHqInBlocks(pickupLocation) {
...
console.log(
  `The pickup location is approximately ${feetToHq} feet away from Scuber's headquarters.`
);
